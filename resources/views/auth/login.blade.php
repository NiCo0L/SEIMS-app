    ...
    <div class="row justify-content-center align-items-center" style="min-height: 75vh;">
        <div class="col-lg-5">
            <div class="brand-panel p-5 mb-4">
                ...
                <h2 class="mb-3">Supply and Equipment Inventory Management System</h2>
                <p class="mb-0 text-white-50">Track consumable supplies, equipment status, transaction histories, and print reports.</p>
            </div>
        </div>
        <div class="col-lg-4">
